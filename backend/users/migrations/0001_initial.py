    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Введите правильное значение.', regex='^[\\w.@+-]+\\Z'), users.validators.username_not_me_validator], verbose_name='Никнейм')),
